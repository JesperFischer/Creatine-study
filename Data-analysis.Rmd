...
table = data %>% group_by(tid,gruppe) %>% summarize(chm = mean(crimphøjremax), chm_sd = sd(crimphøjremax), vcm = mean(crimpvenstremax, na.rm =T), vcm_sd = sd(crimpvenstremax, na.rm =T))
